...
! function(e) {
    ...
    l.formatArr = function(e) {
        ...
        return "static" === a.position ? this : (e = e || "", t.isInput(n) ? lay(n).val(e) : t.rangeElem ? (t.rangeElem[0].val(e ? t.parse("start") : ""), t.rangeElem[1].val(e ? t.parse("end") : "")) : (0 === lay(n).find("*").length && lay(n).html(e), lay(n).attr("lay-date", e)), this)
